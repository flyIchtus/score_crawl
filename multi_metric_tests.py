...
name_real = os.path.dirname(os.path.realpath(__file__)) +  f"/log/{log_prefix}_METR_" + '_'.join(distance_metrics_list) + f'_distance_metrics_{N_samples}_{lt0}_real.p'
name_fake = os.path.dirname(os.path.realpath(__file__)) +  f"/log/{log_prefix}_METR_" + '_'.join(distance_metrics_list) + f'_distance_metrics_{N_samples}_{lt0}_raw.p'
name_fake_unbiased = os.path.dirname(os.path.realpath(__file__)) +  f"/log/{log_prefix}_METR_" + '_'.join(distance_metrics_list) + f'_distance_metrics_{N_samples}_{lt0}_unbiased.p'
