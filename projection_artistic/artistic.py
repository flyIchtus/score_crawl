...
def extract_lonlat() :
    ...
    filename = '/home/poulainauzeaul/home-priam-sidev/stylegan4arome/gan_horovod/projection_artistic/latlon.file'
...
def get_boundaries(Zone) :
    ...
    """
    Zone_l=["NO","SO","SE","NE","C","SE_for_GAN", "SE_GAN_extend"]
    X_min=[230,250,540,460,360,540+55,540]
    Y_min=[300,150,120,300,220,120+78,120]
...
class canvasHolder():
    ...
    def plot_abs_error_sev_cbar(self,data, var_names,
        ...
        #Title='3-fields states'
        fig.subplots_adjust(bottom=0.005, top=0.92, left=0.05, right=0.95)
